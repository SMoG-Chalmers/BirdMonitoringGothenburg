...
This document provides URI identifiers, definitions, and examples for all the attributes (column headers) used in the comma-delimited text files included in the data package.
...
**Definition**:\
The time during which the event occurred, following ISO 8601 date-time standard.
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#BirdNETClass>

**Definition**:\
The taxon scientific name originally classified by BirdNET, prior to the technical validation and reclassification of records.
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#BirdNETConfidence>
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#expertValidated>
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#BirdNETClassAccuracy>
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#misclassificationProbabilities>

**Definition**:\
The likelihood that a species classified by the BirdNET model is actually another species. The misclassification probability of species A being B is calculated as the ratio of the number of times species A was identified as species B, divided by the total number of the ornithologist-validated records of species A.
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#maxMisclassificationProbability>

**Definition**:\
The highest misclassification probability among all possible species misclassifications for a given species.
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#reclassificationSuggestion>

**Definition**:\
The species with the highest misclassification probability, suggesting a possible reclassification of the BirdNET original classification.
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#reclassified>
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#occurrenceAccuracy>

**Definition**:\
An estimation of the accuracy level of the species occurrence that ranges from 0.60 to 1.00, where:
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#commonNameSwedish>
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#commonNameEnglish>
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#detectionDistanceInMeters>
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#siteName>
...
**Identifier**: <https://smog.chalmers.se/projects/bioacoustics-study/occurance-dataset-attributes/#bcl>
